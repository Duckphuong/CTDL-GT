...
// Với mỗi cấu trúc dữ liệu sẽ có một hoặc vài lớp trừu tượng định nghĩa về các tác vụ sẽ
// được hỗ trợ bởi cấu trúc dữ liệu. Trong trường hợp danh sách, đó là lớp IList trong thư
// mục /include/list.
